...
dx login --token 8KULUzaOnMAz3gXnTesN43GVrC2XuIWb
dx describe project-Gg0YQJQJ0jGby8j2Q13JZQbQ
date +%Y-%m-%d\ %H:%M:%S > time.txt
dx upload time.txt --path project-Gg0YQJQJ0jGby8j2Q13JZQbQ:/500k_analysis/time.txt
cp time.txt /mnt/project/500k_analysis/time.txt
dx ls project-Gg0YQJQJ0jGby8j2Q13JZQbQ:/500k_analysis/time.txt
dx-jobutil-report-error "AppError" "Intentional failure for testing purposes."
