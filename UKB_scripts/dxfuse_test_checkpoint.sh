...
destination_base="project-Gg0YQJQJ0jGby8j2Q13JZQbQ:/500k_analysis/intermediate_x4/HearingLoss_White_batch_${BATCH_INDEX}"
destination_base_mnt="/mnt/project/500k_analysis/intermediate_x4/HearingLoss_White_batch_${BATCH_INDEX}"
...
echo "Unzipping model_test.tar.gz..."
tar -xzf model_test.tar.gz
...
# -----------------------------------------------------------------------------
if [ -f "${destination_base_mnt}/${checkpoint_file}" ]; then
